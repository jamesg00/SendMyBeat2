      ...
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-6 md:py-8">
        ...
        <Tabs defaultValue="tags" className="space-y-4 sm:space-y-6">
          <TabsList className="grid w-full max-w-3xl mx-auto grid-cols-5 gap-0.5 sm:gap-1 text-xs sm:text-sm p-0.5 sm:p-1">
            <TabsTrigger value="tags" data-testid="tags-tab" className="px-1 sm:px-3 py-1.5 sm:py-2">Tags</TabsTrigger>
            <TabsTrigger value="descriptions" data-testid="descriptions-tab" className="px-1 sm:px-3 py-1.5 sm:py-2">Desc</TabsTrigger>
            <TabsTrigger value="upload" data-testid="upload-tab" className="px-1 sm:px-3 py-1.5 sm:py-2">Upload</TabsTrigger>
            <TabsTrigger value="analytics" data-testid="analytics-tab" className="px-1 sm:px-3 py-1.5 sm:py-2">Stats</TabsTrigger>
            <TabsTrigger value="grow" data-testid="grow-tab" className="px-1 sm:px-3 py-1.5 sm:py-2">Grow</TabsTrigger>
          </TabsList>
