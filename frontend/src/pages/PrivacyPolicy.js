    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          <h1 className="text-4xl font-bold mb-4 text-slate-800">Privacy Policy</h1>
          <p className="text-slate-600 mb-8">Last Updated: October 16, 2025</p>
          ...
          <div className="space-y-8 text-slate-700">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">2. What We Do</h2>
              <p>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold mb-2 text-slate-700">Account Information:</h3>
              <ul className="list-disc ml-6 mb-4 space-y-1">
                <li>Username and password (encrypted)</li>
                <li>Google account email address (when you connect YouTube)</li>
              </ul>

              <h3 className="text-xl font-semibold mb-2 text-slate-700">Content You Upload:</h3>
              <ul className="list-disc ml-6 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold mb-2 text-slate-700">YouTube Access:</h3>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">4. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">5. Data Storage and Security</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">6. Third-Party Services</h2>
              <p className="mb-3">We use the following third-party services:</p>
              
              <h3 className="text-xl font-semibold mb-2 text-slate-700">Google Services:</h3>
              <ul className="list-disc ml-6 mb-4 space-y-1">
                ...
                <li>Privacy Policy: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://policies.google.com/privacy</a></li>
              </ul>

              <h3 className="text-xl font-semibold mb-2 text-slate-700">OpenAI:</h3>
              <ul className="list-disc ml-6 space-y-1">
                <li><strong>GPT-4o:</strong> For AI-powered tag generation and description creation</li>
                <li>Privacy Policy: <a href="https://openai.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://openai.com/privacy</a></li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">7. Data Sharing</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">8. Your Rights</h2>
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li><strong>Revoke Access:</strong> Disconnect YouTube access at <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://myaccount.google.com/permissions</a></li>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">9. Data Retention</h2>
              <ul className="list-disc ml-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">10. Cookies and Tracking</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">11. Children's Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">12. Changes to This Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">13. Contact Us</h2>
              <p className="mb-3">
                If you have any questions about this privacy policy or our data practices, please contact us:
              </p>
              <ul className="space-y-2">
                <li><strong>Website:</strong> <a href="https://musictag-wizard.preview.emergentagent.com" className="text-blue-600 hover:underline">SendMyBeat.com</a></li>
                <li><strong>For Data Requests:</strong> Use the contact form on our website</li>
              </ul>
            </section>

            <section className="border-t pt-6 mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-slate-800">14. YouTube API Disclosure</h2>
              <p className="mb-3">
