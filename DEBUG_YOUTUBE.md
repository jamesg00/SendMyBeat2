...
```
https://musictag-wizard.preview.emergentagent.com/youtube-callback
```
...
1. **Login to your app:**
   - Go to: https://musictag-wizard.preview.emergentagent.com
...
```bash
# Login first
TOKEN=$(curl -s -X POST https://musictag-wizard.preview.emergentagent.com/api/auth/login \
...
curl -s -H "Authorization: Bearer $TOKEN" \
  https://musictag-wizard.preview.emergentagent.com/api/youtube/auth-url | python3 -m json.tool
```
